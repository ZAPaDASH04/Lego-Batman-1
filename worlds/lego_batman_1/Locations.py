...
character_location_table: Dict[str, LocationData] = {
    LocationName.batman_collected: LocationData(base_location_id + 0, RegionName.bc),
    LocationName.robin_collected: LocationData(base_location_id + 1, RegionName.bc),
    LocationName.brucewayne_collected: LocationData(base_location_id + 2, RegionName.tfo),
    LocationName.alfred_collected: LocationData(base_location_id + 3, RegionName.tfo),
    LocationName.batgirl_collected: LocationData(base_location_id + 4, RegionName.tfo),
    LocationName.nightwing_collected: LocationData(base_location_id + 5, RegionName.tfo),
    LocationName.commissionergordon_collected: LocationData(base_location_id + 6, RegionName.asftc),
    LocationName.policeofficer_collected: LocationData(base_location_id + 7, RegionName.tfo),
    LocationName.fishmonger_collected: LocationData(base_location_id + 8, RegionName.tsga),
    LocationName.militarypoliceman_collected: LocationData(base_location_id + 9, RegionName.tfo),
    LocationName.securityguard_collected: LocationData(base_location_id + 10, RegionName.tfo),
    LocationName.swat_collected: LocationData(base_location_id + 11, RegionName.bb),
    LocationName.scientist_collected: LocationData(base_location_id + 12, RegionName.aet),
    LocationName.sailor_collected: LocationData(base_location_id + 13, RegionName.rtd),
    LocationName.policemarksman_collected: LocationData(base_location_id + 14, RegionName.dol),
    LocationName.clayface_collected: LocationData(base_location_id + 15, RegionName.trmaw),
    LocationName.mrfreeze_collected: LocationData(base_location_id + 16, RegionName.otr),
    LocationName.poisonivy_collected: LocationData(base_location_id + 17, RegionName.gf),
    LocationName.twoface_collected: LocationData(base_location_id + 18, RegionName.aet),   # check about Breaking Blocks
    LocationName.riddler_collected: LocationData(base_location_id + 19, RegionName.aa),
    LocationName.bane_collected: LocationData(base_location_id + 20, RegionName.rtd),
    LocationName.catwoman_collected: LocationData(base_location_id + 21, RegionName.sts),  # Check Arctic World
    LocationName.catwomanclassic_collected: LocationData(base_location_id + 22, RegionName.sts),
    LocationName.killercroc_collected: LocationData(base_location_id + 23, RegionName.adr),
    LocationName.manbat_collected: LocationData(base_location_id + 24, RegionName.pl),
    LocationName.penguin_collected: LocationData(base_location_id + 25, RegionName.aa),
    LocationName.harleyquinn_collected: LocationData(base_location_id + 26, RegionName.asftc), # check about Dying of Laughter
    LocationName.scarecrow_collected: LocationData(base_location_id + 27, RegionName.tjm),
    LocationName.killermoth_collected: LocationData(base_location_id + 28, RegionName.tlotn),
    LocationName.madhatter_collected: LocationData(base_location_id + 29, RegionName.jht),
    LocationName.joker_collected: LocationData(base_location_id + 30, RegionName.aa),
    LocationName.jokertropical_collected: LocationData(base_location_id + 31, RegionName.dol),
    LocationName.poisonivygoon_collected: LocationData(base_location_id + 32, RegionName.apa),
    LocationName.zoosweeper_collected: LocationData(base_location_id + 33, RegionName.zc),
    LocationName.freezegirl_collected: LocationData(base_location_id + 34, RegionName.air),
    LocationName.yeti_collected: LocationData(base_location_id + 35, RegionName.pl),
    LocationName.riddlergoon_collected: LocationData(base_location_id + 36, RegionName.ycbob),
    LocationName.riddlerhenchman_collected: LocationData(base_location_id + 37, RegionName.ycbob),
    LocationName.penguingoons_collected: LocationData(base_location_id + 38, RegionName.tsga),
    LocationName.penguinhenchman_collected: LocationData(base_location_id + 39, RegionName.tsga),
    LocationName.penguinminion_collected: LocationData(base_location_id + 40, RegionName.pl),
    LocationName.jokergoon_collected: LocationData(base_location_id + 41, RegionName.jht),
    LocationName.jokerhenchman_collected: LocationData(base_location_id + 42, RegionName.jht),
    LocationName.clowngoon_collected: LocationData(base_location_id + 43, RegionName.lfabt),
}

hard_character_location_table: Dict[str, LocationData] = {
    LocationName.hush_collected: LocationData(base_location_id + 44, RegionName.sh),
    LocationName.rasalghul_collected: LocationData(base_location_id + 45, RegionName.sh),
    # LocationName.hero1_collected: LocationData(base_location_id + 46, RegionName.bc),
    # LocationName.hero2_collected: LocationData(base_location_id + 47, RegionName.bc),
}

automobile_location_table: Dict[str, LocationData] = {
    LocationName.batmobile_collected: LocationData(base_location_id + 48, RegionName.tfc),
    LocationName.batcycle_collected: LocationData(base_location_id + 49, RegionName.tfc),
    LocationName.policecar_collected: LocationData(base_location_id + 50, RegionName.tfc),
    LocationName.policebike_collected: LocationData(base_location_id + 51, RegionName.tfc),
    LocationName.policevan_collected: LocationData(base_location_id + 52, RegionName.tfc),
    LocationName.battank_collected: LocationData(base_location_id + 53, RegionName.tttot),
    LocationName.catmotorcycle_collected: LocationData(base_location_id + 54, RegionName.sts),
    LocationName.armouredtruck_collected: LocationData(base_location_id + 55, RegionName.aet),
    LocationName.freezekart_collected: LocationData(base_location_id + 56, RegionName.otr),
    LocationName.hammertruck_collected: LocationData(base_location_id + 57, RegionName.asftc),
    LocationName.jokervan_collected: LocationData(base_location_id + 58, RegionName.tfc),
    LocationName.garbagetruck_collected: LocationData(base_location_id + 59, RegionName.tlotn),
}

watercraft_location_table: Dict[str, LocationData] = {
    LocationName.batboat_collected: LocationData(base_location_id + 60, RegionName.bbb),
    LocationName.robinswatercraft_collected: LocationData(base_location_id + 61, RegionName.bbb),
    LocationName.robinssubmarine_collected: LocationData(base_location_id + 62, RegionName.bbb),
    LocationName.policewatercraft_collected: LocationData(base_location_id + 63, RegionName.hag),
    LocationName.policeboat_collected: LocationData(base_location_id + 64, RegionName.hag),
    LocationName.penguinsubmarine_collected: LocationData(base_location_id + 65, RegionName.hag),
    LocationName.swamprider_collected: LocationData(base_location_id + 66, RegionName.hag),
    LocationName.penguingoonsub_collected: LocationData(base_location_id + 67, RegionName.bbb),
    LocationName.iceberg_collected: LocationData(base_location_id + 68, RegionName.otr),
    LocationName.steamboat_collected: LocationData(base_location_id + 69, RegionName.jht),
}

aircraft_location_table: Dict[str, LocationData] = {
    LocationName.batwing_collected: LocationData(base_location_id + 70, RegionName.fotb),
    LocationName.batcopter_collected: LocationData(base_location_id + 71, RegionName.fotb),
    LocationName.harbourhelicopter_collected: LocationData(base_location_id + 72, RegionName.bbb),
    LocationName.policehelicopter_collected: LocationData(base_location_id + 73, RegionName.bbpl),
    LocationName.privatejet_collected: LocationData(base_location_id + 74, RegionName.fotb),
    LocationName.jokerhelicopter_collected: LocationData(base_location_id + 75, RegionName.bbpl),
    LocationName.scarecrowbiplane_collected: LocationData(base_location_id + 76, RegionName.bbpl),
    LocationName.goonhelicopter_collected: LocationData(base_location_id + 77, RegionName.bbpl),
    LocationName.riddlerjet_collected: LocationData(base_location_id + 78, RegionName.bb),
    LocationName.glider_collected: LocationData(base_location_id + 79, RegionName.jht),
}
...
minikit_location_table: Dict[str, LocationData] = {
    ...
    LocationName.tfo_min6: LocationData(base_location_id + 145, RegionName.tfo),
    LocationName.tfo_min7: LocationData(base_location_id + 146, RegionName.tfo),
    LocationName.tfo_min8: LocationData(base_location_id + 147, RegionName.tfo),
    LocationName.tfo_min9: LocationData(base_location_id + 148, RegionName.tfo),
    LocationName.tfo_min10: LocationData(base_location_id + 149, RegionName.tfo),
    ...
    LocationName.bbb_min3: LocationData(base_location_id + 162, RegionName.bbb),
    LocationName.bbb_min4: LocationData(base_location_id + 163, RegionName.bbb),
    LocationName.bbb_min5: LocationData(base_location_id + 164, RegionName.bbb),
    LocationName.bbb_min6: LocationData(base_location_id + 165, RegionName.bbb),
    ...
    LocationName.bbb_min9: LocationData(base_location_id + 168, RegionName.bbb),
    LocationName.bbb_min10: LocationData(base_location_id + 169, RegionName.bbb),
    # Under the City
    ...
    LocationName.utc_min5: LocationData(base_location_id + 174, RegionName.utc),
    LocationName.utc_min6: LocationData(base_location_id + 175, RegionName.utc),
    LocationName.utc_min7: LocationData(base_location_id + 176, RegionName.utc),
    LocationName.utc_min8: LocationData(base_location_id + 177, RegionName.utc),
    LocationName.utc_min9: LocationData(base_location_id + 178, RegionName.utc),
    LocationName.utc_min10: LocationData(base_location_id + 179, RegionName.utc),
    # Zoo's Company
    ...
    LocationName.zc_min5: LocationData(base_location_id + 184, RegionName.zc),
    LocationName.zc_min6: LocationData(base_location_id + 185, RegionName.zc),
    LocationName.zc_min7: LocationData(base_location_id + 186, RegionName.zc),
    LocationName.zc_min8: LocationData(base_location_id + 187, RegionName.zc),
    LocationName.zc_min9: LocationData(base_location_id + 188, RegionName.zc),
    LocationName.zc_min10: LocationData(base_location_id + 189, RegionName.zc),
    # Penguin's Lair
    ...
    LocationName.pl_min4: LocationData(base_location_id + 193, RegionName.pl),
    LocationName.pl_min5: LocationData(base_location_id + 194, RegionName.pl),
    LocationName.pl_min6: LocationData(base_location_id + 195, RegionName.pl),
    LocationName.pl_min7: LocationData(base_location_id + 196, RegionName.pl),
    LocationName.pl_min8: LocationData(base_location_id + 197, RegionName.pl),
    LocationName.pl_min9: LocationData(base_location_id + 198, RegionName.pl),
    LocationName.pl_min10: LocationData(base_location_id + 199, RegionName.pl),
    # Joker's Home Turf
    ...
    LocationName.lfabt_min3: LocationData(base_location_id + 212, RegionName.lfabt),
    LocationName.lfabt_min4: LocationData(base_location_id + 213, RegionName.lfabt),
    LocationName.lfabt_min5: LocationData(base_location_id + 214, RegionName.lfabt),
    LocationName.lfabt_min6: LocationData(base_location_id + 215, RegionName.lfabt),
    LocationName.lfabt_min7: LocationData(base_location_id + 216, RegionName.lfabt),
    LocationName.lfabt_min8: LocationData(base_location_id + 217, RegionName.lfabt),
    LocationName.lfabt_min9: LocationData(base_location_id + 218, RegionName.lfabt),
    LocationName.lfabt_min10: LocationData(base_location_id + 219, RegionName.lfabt),
    # Flight of the Bat
    ...
    LocationName.itdn_min4: LocationData(base_location_id + 233, RegionName.itdn),
    LocationName.itdn_min5: LocationData(base_location_id + 234, RegionName.itdn),
    LocationName.itdn_min6: LocationData(base_location_id + 235, RegionName.itdn),
    LocationName.itdn_min7: LocationData(base_location_id + 236, RegionName.itdn),
    LocationName.itdn_min8: LocationData(base_location_id + 237, RegionName.itdn),
    LocationName.itdn_min9: LocationData(base_location_id + 238, RegionName.itdn),
    LocationName.itdn_min10: LocationData(base_location_id + 239, RegionName.itdn),
    # To the Top of the Tower
    LocationName.tttot_min1: LocationData(base_location_id + 240, RegionName.tttot),
    LocationName.tttot_min2: LocationData(base_location_id + 241, RegionName.tttot),
    LocationName.tttot_min3: LocationData(base_location_id + 242, RegionName.tttot),
    LocationName.tttot_min4: LocationData(base_location_id + 243, RegionName.tttot),
    LocationName.tttot_min5: LocationData(base_location_id + 244, RegionName.tttot),
    LocationName.tttot_min6: LocationData(base_location_id + 245, RegionName.tttot),
    LocationName.tttot_min7: LocationData(base_location_id + 246, RegionName.tttot),
    LocationName.tttot_min8: LocationData(base_location_id + 247, RegionName.tttot),
    LocationName.tttot_min9: LocationData(base_location_id + 248, RegionName.tttot),
    LocationName.tttot_min10: LocationData(base_location_id + 249, RegionName.tttot),
    ...
    LocationName.aw_min6: LocationData(base_location_id + 345, RegionName.aw),
    LocationName.aw_min7: LocationData(base_location_id + 346, RegionName.awf),
    LocationName.aw_min8: LocationData(base_location_id + 347, RegionName.awf),
...
hostage_location_table: Dict[str, LocationData] = {
    ...
    LocationName.zc_host: LocationData(base_location_id + 406, RegionName.zc),
    LocationName.pl_host: LocationData(base_location_id + 407, RegionName.pl),
    LocationName.jht_host: LocationData(base_location_id + 408, RegionName.jht),
    LocationName.lfabt_host: LocationData(base_location_id + 409, RegionName.lfabt),
    LocationName.itdn_host: LocationData(base_location_id + 410, RegionName.itdn),
...
true_status_location_table: Dict[str, LocationData] = {
    ...
    LocationName.itdn_ts: LocationData(base_location_id + 468, RegionName.itdn),
    LocationName.tttot_ts: LocationData(base_location_id + 469, RegionName.tttot),
...
red_brick_location_table = {
    ...
    LocationName.tfo_rb: LocationData(base_location_id + 489, RegionName.tfo),
    LocationName.tsga_rb: LocationData(base_location_id + 490, RegionName.tsgaf),
    LocationName.bbb_rb: LocationData(base_location_id + 491, RegionName.bbb),
    LocationName.utc_rb: LocationData(base_location_id + 492, RegionName.utc),
    LocationName.zc_rb: LocationData(base_location_id + 493, RegionName.zc),
    LocationName.pl_rb: LocationData(base_location_id + 494, RegionName.pl),
    ...
    LocationName.itdn_rb: LocationData(base_location_id + 498, RegionName.itdn),
...
red_brick_purchase_table = {
    LocationName.silhouettes: LocationData(base_location_id + 515, RegionName.sh),
    LocationName.beepbeep: LocationData(base_location_id + 516, RegionName.sh),
    LocationName.icerink: LocationData(base_location_id + 517, RegionName.sh),
    LocationName.disguise: LocationData(base_location_id + 518, RegionName.sh),
    LocationName.extratoggle: LocationData(base_location_id + 519, RegionName.sh),
    LocationName.scorex2: LocationData(base_location_id + 520, RegionName.sh),
    LocationName.scorex4: LocationData(base_location_id + 521, RegionName.sh),
    LocationName.scorex6: LocationData(base_location_id + 522, RegionName.sh),
    LocationName.scorex8: LocationData(base_location_id + 523, RegionName.sh),
    LocationName.scorex10: LocationData(base_location_id + 524, RegionName.sh),
    LocationName.studmagnet: LocationData(base_location_id + 525, RegionName.sh),
    LocationName.charstuds: LocationData(base_location_id + 526, RegionName.sh),
    LocationName.minikitdetect: LocationData(base_location_id + 527, RegionName.sh),
    LocationName.pwrbrickdetect: LocationData(base_location_id + 528, RegionName.sh),
    LocationName.alwaysscore: LocationData(base_location_id + 529, RegionName.sh),
    LocationName.fastbuild: LocationData(base_location_id + 530, RegionName.sh),
    LocationName.immunefreeze: LocationData(base_location_id + 531, RegionName.sh),
    LocationName.regenhearts: LocationData(base_location_id + 532, RegionName.sh),
    LocationName.extrahearts: LocationData(base_location_id + 533, RegionName.sh),
    LocationName.invincibility: LocationData(base_location_id + 534, RegionName.sh),
    LocationName.fastgrapple: LocationData(base_location_id + 535, RegionName.sh),
    LocationName.fastbatarang: LocationData(base_location_id + 536, RegionName.sh),
    LocationName.moretargets: LocationData(base_location_id + 537, RegionName.sh),
    LocationName.flamingbata: LocationData(base_location_id + 538, RegionName.sh),
    LocationName.slam: LocationData(base_location_id + 539, RegionName.sh),
    LocationName.moredet: LocationData(base_location_id + 540, RegionName.sh),
    LocationName.armorplating: LocationData(base_location_id + 541, RegionName.sh),
    LocationName.sonicpain: LocationData(base_location_id + 542, RegionName.sh),
    LocationName.areaeffect: LocationData(base_location_id + 543, RegionName.sh),
    LocationName.bats: LocationData(base_location_id + 544, RegionName.sh),
    LocationName.freezebatarang: LocationData(base_location_id + 545, RegionName.sh),
    LocationName.decoy: LocationData(base_location_id + 546, RegionName.sh),
    LocationName.fastwalk: LocationData(base_location_id + 547, RegionName.sh),
    LocationName.fasterpieces: LocationData(base_location_id + 548, RegionName.sh),
    LocationName.piecedetect: LocationData(base_location_id + 549, RegionName.sh),
}
