...
character_token_table: Dict[str, LocationData] = {
    ...
    LocationName.brucewayne_token: LocationData(base_location_id + 575, RegionName.bc),
    LocationName.alfred_token: LocationData(base_location_id + 576, RegionName.bc),
    LocationName.batgirl_token: LocationData(base_location_id + 577, RegionName.bc),
    LocationName.nightwing_token: LocationData(base_location_id + 578, RegionName.bc),
    LocationName.policeofficer_token: LocationData(base_location_id + 579, RegionName.bc),
    LocationName.militarypoliceman_token: LocationData(base_location_id + 580, RegionName.bc),
    LocationName.securityguard_token: LocationData(base_location_id + 581, RegionName.bc),
    LocationName.battank_token: LocationData(base_location_id + 582, RegionName.bc),
