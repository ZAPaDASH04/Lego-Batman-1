...
character_location_table: Dict[str, LocationData] = {
    ...
    LocationName.brucewayne_collected: LocationData(base_location_id + 2, RegionName.sh, 100000),
    LocationName.alfred_collected: LocationData(base_location_id + 3, RegionName.sh, 75000),
    LocationName.batgirl_collected: LocationData(base_location_id + 4, RegionName.sh, 100000),
    LocationName.nightwing_collected: LocationData(base_location_id + 5, RegionName.sh, 125000),
    LocationName.commissionergordon_collected: LocationData(base_location_id + 6, RegionName.sh, 25000),
    LocationName.policeofficer_collected: LocationData(base_location_id + 7, RegionName.sh, 5000),
    LocationName.fishmonger_collected: LocationData(base_location_id + 8, RegionName.sh, 4000),
    LocationName.militarypoliceman_collected: LocationData(base_location_id + 9, RegionName.sh, 17000),
    LocationName.securityguard_collected: LocationData(base_location_id + 10, RegionName.sh, 10000),
    LocationName.swat_collected: LocationData(base_location_id + 11, RegionName.sh, 10000),
    LocationName.scientist_collected: LocationData(base_location_id + 12, RegionName.sh, 6000),
    LocationName.sailor_collected: LocationData(base_location_id + 13, RegionName.sh, 5000),
    LocationName.policemarksman_collected: LocationData(base_location_id + 14, RegionName.sh, 5000),
    ...
    LocationName.twoface_collected: LocationData(base_location_id + 18, RegionName.aa),
    ...
    LocationName.catwoman_collected: LocationData(base_location_id + 21, RegionName.aa),
    LocationName.catwomanclassic_collected: LocationData(base_location_id + 22, RegionName.sh, 67000),
    LocationName.killercroc_collected: LocationData(base_location_id + 23, RegionName.adr),
    LocationName.manbat_collected: LocationData(base_location_id + 24, RegionName.sh, 40000),
    LocationName.penguin_collected: LocationData(base_location_id + 25, RegionName.aa),
    LocationName.harleyquinn_collected: LocationData(base_location_id + 26, RegionName.aa),
    ...
    LocationName.madhatter_collected: LocationData(base_location_id + 29, RegionName.sh, 35000),
    LocationName.joker_collected: LocationData(base_location_id + 30, RegionName.aa),
    LocationName.jokertropical_collected: LocationData(base_location_id + 31, RegionName.sh, 30000),
    LocationName.poisonivygoon_collected: LocationData(base_location_id + 32, RegionName.sh, 25000),
    LocationName.zoosweeper_collected: LocationData(base_location_id + 33, RegionName.sh, 12500),
    LocationName.freezegirl_collected: LocationData(base_location_id + 34, RegionName.sh, 4000),
    LocationName.yeti_collected: LocationData(base_location_id + 35, RegionName.sh, 9000),
    LocationName.riddlergoon_collected: LocationData(base_location_id + 36, RegionName.sh, 6000),
    LocationName.riddlerhenchman_collected: LocationData(base_location_id + 37, RegionName.sh, 7000),
    LocationName.penguingoon_collected: LocationData(base_location_id + 38, RegionName.sh, 3000),
    LocationName.penguinhenchman_collected: LocationData(base_location_id + 39, RegionName.sh, 5000),
    LocationName.penguinminion_collected: LocationData(base_location_id + 40, RegionName.sh, 30000),
    LocationName.jokergoon_collected: LocationData(base_location_id + 41, RegionName.sh, 7000),
    LocationName.jokerhenchman_collected: LocationData(base_location_id + 42, RegionName.sh, 9000),
    LocationName.clowngoon_collected: LocationData(base_location_id + 43, RegionName.sh, 100000),
    # Hush
    # Ras
    # LocationName.hero1_collected: LocationData(base_location_id + 46, RegionName.sh),
    # LocationName.hero2_collected: LocationData(base_location_id + 47, RegionName.sh),
    ...
    LocationName.policecar_collected: LocationData(base_location_id + 50, RegionName.sh, 10000),
    LocationName.policebike_collected: LocationData(base_location_id + 51, RegionName.sh, 11000),
    LocationName.policevan_collected: LocationData(base_location_id + 52, RegionName.sh, 13000),
    LocationName.battank_collected: LocationData(base_location_id + 53, RegionName.sh, 200000),
    LocationName.catmotorcycle_collected: LocationData(base_location_id + 54, RegionName.sh, 23000),
    LocationName.armouredtruck_collected: LocationData(base_location_id + 55, RegionName.sh, 24000),
    LocationName.freezekart_collected: LocationData(base_location_id + 56, RegionName.sh, 25000),
    LocationName.hammertruck_collected: LocationData(base_location_id + 57, RegionName.sh, 80000),
    LocationName.jokervan_collected: LocationData(base_location_id + 58, RegionName.sh, 60000),
    LocationName.garbagetruck_collected: LocationData(base_location_id + 59, RegionName.sh, 99000),
    ...
    LocationName.robinssubmarine_collected: LocationData(base_location_id + 62, RegionName.sh, 30000),
    LocationName.policewatercraft_collected: LocationData(base_location_id + 63, RegionName.sh, 12000),
    LocationName.policeboat_collected: LocationData(base_location_id + 64, RegionName.sh, 13000),
    ...
    LocationName.penguingoonsub_collected: LocationData(base_location_id + 67, RegionName.sh, 15000),
    LocationName.iceberg_collected: LocationData(base_location_id + 68, RegionName.sh, 23000),
    LocationName.steamboat_collected: LocationData(base_location_id + 69, RegionName.sh, 23000),
    ...
    LocationName.harbourhelicopter_collected: LocationData(base_location_id + 72, RegionName.sh, 16000),
    LocationName.policehelicopter_collected: LocationData(base_location_id + 73, RegionName.sh, 14000),
    LocationName.privatejet_collected: LocationData(base_location_id + 74, RegionName.sh, 15000),
    ...
    LocationName.goonhelicopter_collected: LocationData(base_location_id + 77, RegionName.sh, 11000),
    LocationName.riddlerjet_collected: LocationData(base_location_id + 78, RegionName.sh, 17000),
    LocationName.glider_collected: LocationData(base_location_id + 79, RegionName.sh, 18000),
}

hard_character_location_table: Dict[str, LocationData] = {
    LocationName.hush_collected: LocationData(base_location_id + 44, RegionName.sh, 150000),
    LocationName.rasalghul_collected: LocationData(base_location_id + 45, RegionName.sh, 500000),
...
character_token_table: Dict[str, LocationData] = {
    # LocationName.batman_token: LocationData(base_location_id + 550, RegionName.bc),
    # LocationName.robin_token: LocationData(base_location_id + 551, RegionName.bc),
    LocationName.brucewayne_token: LocationData(base_location_id + 552, RegionName.bc),
    LocationName.alfred_token: LocationData(base_location_id + 553, RegionName.bc),
    LocationName.batgirl_token: LocationData(base_location_id + 554, RegionName.bc),
    LocationName.nightwing_token: LocationData(base_location_id + 555, RegionName.bc),
    LocationName.commissionergordon_token: LocationData(base_location_id + 556, RegionName.asftc),
    LocationName.policeofficer_token: LocationData(base_location_id + 557, RegionName.bc),
    LocationName.fishmonger_token: LocationData(base_location_id + 558, RegionName.tsga),
    LocationName.militarypoliceman_token: LocationData(base_location_id + 559, RegionName.bc),
    LocationName.securityguard_token: LocationData(base_location_id + 560, RegionName.bc),
    LocationName.swat_token: LocationData(base_location_id + 561, RegionName.bb),
    LocationName.scientist_token: LocationData(base_location_id + 562, RegionName.aet),
    LocationName.sailor_token: LocationData(base_location_id + 563, RegionName.rtd),
    LocationName.policemarksman_token: LocationData(base_location_id + 564, RegionName.dol),
    # LocationName.clayface_token: LocationData(base_location_id + 565, RegionName.trmaw),
    # LocationName.mrfreeze_token: LocationData(base_location_id + 566, RegionName.otr),
    # LocationName.poisonivy_token: LocationData(base_location_id + 567, RegionName.apa),
    # LocationName.twoface_token: LocationData(base_location_id + 568, RegionName.bb),
    # LocationName.riddler_token: LocationData(base_location_id + 569, RegionName.ycbob),
    # LocationName.bane_token: LocationData(base_location_id + 570, RegionName.rtd),
    # LocationName.catwoman_token: LocationData(base_location_id + 571, RegionName.sts),
    LocationName.catwomanclassic_token: LocationData(base_location_id + 572, RegionName.sts),
    # LocationName.killercroc_token: LocationData(base_location_id + 573, RegionName.adr),
    LocationName.manbat_token: LocationData(base_location_id + 574, RegionName.pl),
    # LocationName.penguin_token: LocationData(base_location_id + 575, RegionName.tsga),
    # LocationName.harleyquinn_token: LocationData(base_location_id + 576, RegionName.jht),
    # LocationName.scarecrow_token: LocationData(base_location_id + 577, RegionName.tlotn),
    # LocationName.killermoth_token: LocationData(base_location_id + 578, RegionName.tlotn),
    LocationName.madhatter_token: LocationData(base_location_id + 579, RegionName.jht),
    # LocationName.joker_token: LocationData(base_location_id + 580, RegionName.jht),
    LocationName.jokertropical_token: LocationData(base_location_id + 581, RegionName.dol),
    LocationName.poisonivygoon_token: LocationData(base_location_id + 582, RegionName.apa),
    LocationName.zoosweeper_token: LocationData(base_location_id + 583, RegionName.zc),
    LocationName.freezegirl_token: LocationData(base_location_id + 584, RegionName.air),
    LocationName.yeti_token: LocationData(base_location_id + 585, RegionName.pl),
    LocationName.riddlergoon_token: LocationData(base_location_id + 586, RegionName.ycbob),
    LocationName.riddlerhenchman_token: LocationData(base_location_id + 587, RegionName.ycbob),
    LocationName.penguingoon_token: LocationData(base_location_id + 588, RegionName.tsga),
    LocationName.penguinhenchman_token: LocationData(base_location_id + 589, RegionName.tsga),
    LocationName.penguinminion_token: LocationData(base_location_id + 590, RegionName.pl),
    LocationName.jokergoon_token: LocationData(base_location_id + 591, RegionName.jht),
    LocationName.jokerhenchman_token: LocationData(base_location_id + 592, RegionName.jht),
    LocationName.clowngoon_token: LocationData(base_location_id + 593, RegionName.lfabt),
    LocationName.hush_token: LocationData(base_location_id + 594, RegionName.tjm),
    LocationName.rasalghul_token: LocationData(base_location_id + 595, RegionName.tjm),
    # LocationName.hero1_token: LocationData(base_location_id + 596, RegionName.tjm),
    # LocationName.hero2_token: LocationData(base_location_id + 597, RegionName.tjm),
    # LocationName.batmobile_token: LocationData(base_location_id + 598, RegionName.tfc),
    # LocationName.batcycle_token: LocationData(base_location_id + 599, RegionName.tfc),
    LocationName.policecar_token: LocationData(base_location_id + 600, RegionName.tfc),
    LocationName.policebike_token: LocationData(base_location_id + 601, RegionName.tfc),
    LocationName.policevan_token: LocationData(base_location_id + 602, RegionName.tfc),
    LocationName.battank_token: LocationData(base_location_id + 603, RegionName.bc),
    LocationName.catmotorcycle_token: LocationData(base_location_id + 604, RegionName.sts),
    LocationName.armouredtruck_token: LocationData(base_location_id + 605, RegionName.aet),
    LocationName.freezekart_token: LocationData(base_location_id + 606, RegionName.otr),
    LocationName.hammertruck_token: LocationData(base_location_id + 607, RegionName.asftc),
    LocationName.jokervan_token: LocationData(base_location_id + 608, RegionName.tfc),
    LocationName.garbagetruck_token: LocationData(base_location_id + 609, RegionName.tlotn),
    # LocationName.batboat_token: LocationData(base_location_id + 610, RegionName.bbb),
    # LocationName.robinswatercraft_token: LocationData(base_location_id + 611, RegionName.bbb),
    LocationName.robinssubmarine_token: LocationData(base_location_id + 612, RegionName.bbb),
    LocationName.policewatercraft_token: LocationData(base_location_id + 613, RegionName.hag),
    LocationName.policeboat_token: LocationData(base_location_id + 614, RegionName.hag),
    # LocationName.penguinsubmarine_token: LocationData(base_location_id + 615, RegionName.hag),
    # LocationName.swamprider_token: LocationData(base_location_id + 616, RegionName.hag),
    LocationName.penguingoonsub_token: LocationData(base_location_id + 617, RegionName.bbb),
    LocationName.iceberg_token: LocationData(base_location_id + 618, RegionName.otr),
    LocationName.steamboat_token: LocationData(base_location_id + 619, RegionName.jht),
    # LocationName.batwing_token: LocationData(base_location_id + 620, RegionName.fotb),
    # LocationName.batcopter_token: LocationData(base_location_id + 621, RegionName.fotb),
    LocationName.harbourhelicopter_token: LocationData(base_location_id + 622, RegionName.bbb),
    LocationName.policehelicopter_token: LocationData(base_location_id + 623, RegionName.bbpl),
    LocationName.privatejet_token: LocationData(base_location_id + 624, RegionName.fotb),
    # LocationName.jokerhelicopter_token: LocationData(base_location_id + 625, RegionName.bbpl),
    # LocationName.scarecrowbiplane_token: LocationData(base_location_id + 626, RegionName.bbpl),
    LocationName.goonhelicopter_token: LocationData(base_location_id + 627, RegionName.bbpl),
    LocationName.riddlerjet_token: LocationData(base_location_id + 628, RegionName.bb),
    LocationName.glider_token: LocationData(base_location_id + 629, RegionName.jht),
}
