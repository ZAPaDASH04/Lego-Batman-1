...
red_brick_unlocked_table: Dict[str, LB1ItemData] = {
    ...
    ItemName.scorex2_un: LB1ItemData(base_item_id + 520, ItemClassification.progression),
    ItemName.scorex4_un: LB1ItemData(base_item_id + 521, ItemClassification.progression),
    ItemName.scorex6_un: LB1ItemData(base_item_id + 522, ItemClassification.progression),
    ItemName.scorex8_un: LB1ItemData(base_item_id + 523, ItemClassification.progression),
    ItemName.scorex10_un: LB1ItemData(base_item_id + 524, ItemClassification.progression),
